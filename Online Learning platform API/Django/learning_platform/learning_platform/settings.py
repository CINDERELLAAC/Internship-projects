...
SECRET_KEY = 'django-insecure-%n@0&@q3ioe=iar(1rujv568b-d9p5dzeyt4qyd_tgk!f!w2)#'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'cinderellashajuamban@gmail.com'
EMAIL_HOST_PASSWORD = 'your-email-password'
'''
ADMINS = [('Cinderella A C', 'cinderellashajuamban@gmail.com')]
...
CSRF_COOKIE_SECURE = False  # Disable secure CSRF cookies for local development
